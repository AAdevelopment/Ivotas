...
public interface Comunication_server extends Remote {
    ...
    public boolean vote(String lista, Eleicao eleicao, Pessoa pessoa, Mesa_voto mesa, Date data)throws RemoteException;
    ...
    public  void CriarLista(String eleicao,ArrayList<String> lista,String nome,String tipo)throws RemoteException;
